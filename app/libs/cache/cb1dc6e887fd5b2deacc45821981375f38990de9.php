...
<aside class="main-sidebar elevation-4 sidebar-dark-primary">
    <a href="<?php echo e(BASE_URL); ?>principal" class="brand-link">
        <img src="<?php echo e(IMG_ROUTE); ?>default/your-logo2.png" alt="Logo" class="brand-image">
        <span class="brand-text font-weight-light text-white d-inline">
            <img src="<?php echo e(IMG_ROUTE); ?>default/your-text.png" alt="Logo" class="w-50">
        </span>
    </a>
    <div class="sidebar">
        <nav class="mt-2">
                ...
                foreach ($menus as $m) {
                    ...
                    <li class="nav-item parent has-treeview">
                        <a href="#" class="nav-link parent">
                            <i class="nav-icon <?php echo e($modulo_icono); ?>"></i>
                            <p>
                                <?php echo e($modulo_nombre); ?>
                        ...
                        if (count($modulos) > 0) {
                            ...
                            foreach ($modulos as $v) {
                                ...
                                <li class="nav-item child">
                                    <a href="<?php echo e($vista_url); ?>" class="nav-link child">
...
</aside><?php /**PATH C:\xampp\htdocs\applectura\app\views/layouts/includes/menu.blade.php ENDPATH**/ ?>