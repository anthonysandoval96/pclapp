...
<div class="login-page" style="height: 85vh !important;">
    <div class="login-box m-auto">
        <div class="login-logo">
            <img class="w-50 pr-2" src="<?php echo e(CUSTOM_ROUTE); ?>img/default/logo.png" alt="">
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="text-center">
                    <a href="<?php echo e(BASE_URL); ?>login/forgot">Olvidé mi contraseña</a>
                </div>
                <div class="text-center mt-3">
                    <a href="<?php echo e(BASE_URL); ?>register" class="d-inline-block h1 border rounded border-info px-3 py-1">
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(CUSTOM_ROUTE); ?>js/access/login.js?<?php echo e(CACHE_VERSION); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pclapp\app\views/access/login.blade.php ENDPATH**/ ?>