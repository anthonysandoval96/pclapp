...
<div class="content">
    <div class="container">
        ...
        <div class="row py-4">
            ...
            <div class="col-12 col-md-4 text-center mb-3">
                <a href="<?php echo e(BASE_URL); ?>usuario/precios" class="btn border-success">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pclapp\app\views/homeadmin.blade.php ENDPATH**/ ?>