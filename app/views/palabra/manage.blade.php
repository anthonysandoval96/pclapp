...
@section('css')
    <link rel="stylesheet" href="{{ PLUGINS_ROUTE }}datatables/jquery.dataTables.min.css?{{CACHE_VERSION}}">
    <link rel="stylesheet" href="{{ PLUGINS_ROUTE }}datatables/buttons.dataTables.min.css?{{CACHE_VERSION}}">
@endsection
