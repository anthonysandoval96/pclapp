...
<div class="modal fade" id="modal-import-{{$controller}}" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <form id="form-import-{{$controller}}" name="form-import-{{$controller}}" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <div class="position-relative">
                                ...
                                <input id="file-upload" name="file-upload" data-file="{{$controller}}" onchange='pasarInfoDocument()' type="file" accept=".csv, .xlsx, .xls" style='display: none;'/>
                                <div id="info">Ningún archivo seleccionado.</div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="text-center"><div class="spinner-border import {{$controller}} text-secondary"></div></div>
                            <div class="row text-center my-3" id="row-ajaxdata-main" style="display: none;">
                                ...
                                <div class="col-12">
                                    <div class="table-responsive" style="max-height: 300px;">
                                        <table id="table-import-{{getPluralPrase($controller)}}" class="table table-bordered table-hover table-custom">
                                            <thead>
                                                <tr>
                                                    <th>Palabra</th>
                                                    <th>Significado</th>
                                            ...
                                            <tbody id="tbody-import-{{getPluralPrase($controller)}}"></tbody>
                                        </table>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                    <button id="btn-postimport-{{$controller}}" type="button" class="btn btn-primary">Importar</button>
                </div>
            </div>
        </form>
    </div>
