                        ...
                        <div class="card avatar-change">
                                ...
                                <div class="avatar-default">
                                    <div class="row">
                                        <div class="col-6 col-lg-12 m-auto">
                                            <img id="avatar-upload" src="{{CUSTOM_ROUTE}}img/usuarios/{{$userlogued["avatar"]}}" class="avatar w-100 rounded" alt="avatar">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-center bg-white border-top p-3">
                                <div class="avatar-btns">
                                    ...
                                    <button id="btn-cancelar-avatar" data-avatar="usuarios" data-imgrecorded="{{$userlogued["avatar"]}}" class="btn btn-danger" type="button">Cancelar</button>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control" id="in-reniec-nombres" name="in-usuario-nombres" maxlength="50" value="{{$userlogued["nombres"]}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control" id="in-reniec-appaterno" name="in-usuario-appaterno" maxlength="40" value="{{$userlogued["apellido_paterno"]}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control" id="in-reniec-apmaterno" name="in-usuario-apmaterno" maxlength="40" value="{{$userlogued["apellido_materno"]}}">
                                    ...
                                    {{-- <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <select id="sel-reniec-genero" name="sel-usuario-genero" class="form-control">
                                                ...
                                                <?php
                                                for ($i = 0; $i < count($array_genero_values); $i++) {
                                                    if ($array_genero_values[$i] == $userlogued["genero"]) {
                                                        ?>
                                                        <option value="<?= $array_genero_values[$i]; ?>" selected><?= ucwords($array_genero_values[$i]); ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?= $array_genero_values[$i]; ?>"><?= ucwords($array_genero_values[$i]); ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="date" class="form-control center-text" id="in-reniec-fnacimiento" name="in-usuario-fnacimiento" maxlength="45" value="{{$userlogued["fecha_nacimiento"]}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="number" step="1" class="form-control" id="in-usuario-celular" name="in-usuario-celular" placeholder="Ejem. 960794123" value="{{$userlogued["celular"]}}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group position-relative">
                                            <label for="in-usuario-email" class="control-label">Email</label>
                                            <input type="email" class="form-control" id="in-usuario-email" name="in-usuario-email" maxlength="45" value="{{$userlogued["email"]}}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-7">
                                        <div class="form-group position-relative">
                                            <label for="in-usuario-direccion" class="control-label">Dirección</label>
                                            <input type="text" class="form-control" id="in-usuario-direccion" name="in-usuario-direccion" maxlength="100" value="{{$userlogued["direccion"]}}">
                                        </div>
                                    </div> --}}
                                    <div class="col-6">
                                        <a href="{{BASE_URL}}principal" class="btn btn-secondary w-100"><i class="far fa-arrow-alt-circle-left mr-2"></i>Regresar</a>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <input id="hdn-usuario-id" name="hdn-usuario-id" type="hidden" value="{{$userlogued["id"]}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            <form id="form-change-password" name="form-change-password" autocomplete="off">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="hidden" id="hdn-usuario-ps-id" name="hdn-usuario-ps-id" value="{{$userlogued["id"]}}">
                                </div>
                            </form>
                        </div>
                    </div>
