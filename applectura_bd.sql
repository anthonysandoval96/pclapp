...
-- Tiempo de generación: 24-06-2021 a las 01:43:30
...
INSERT INTO `persona` (`id`, `nombres`, `apellido_paterno`, `apellido_materno`, `fecha_nacimiento`, `genero`, `direccion`, `email`, `celular`) VALUES
(1, 'Eduardo Salvador', 'Correa', 'Rojas', '1996-05-01', 'masculino', NULL, 'edsacor@yahoo.com', '961969312');
...
(1, 'admin', '$2y$10$Rwi4pf53C18xMt6P0PRYpuOst3gXPRVye./oDrRyX/6n/WZc.7S46', 'usuario1.png', 1, 1, 1, '2021-06-20');
...
ALTER TABLE `persona`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `apellido_paterno` (`apellido_paterno`),
  ADD UNIQUE KEY `apellido_materno` (`apellido_materno`);
